...
# Center your title content manually
st.markdown("<div class='title-container'><h1>🚀 Toxicity Detection — English, Malayalam & Manglish</h1><h3>Choose your language to proceed</h3></div>", unsafe_allow_html=True)
